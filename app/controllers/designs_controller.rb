class DesignsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @design.save
        format.html { redirect_to :back, notice: 'Design was successfully created.' }
  ...
  def destroy
    @design.destroy
    respond_to do |format|
      format.html { redirect_to :back, notice: 'Design was successfully destroyed.' }
  ...
  private
    ...
    def design_params
      params.require(:design).permit(:title, :subtitle, :background_color, :wellcolor)
    end
end
