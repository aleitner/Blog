...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { background_color: @design.background_color, subtitle: @design.subtitle, title: @design.title }
    end
  ...
  test "should update design" do
    patch :update, id: @design, design: { background_color: @design.background_color, subtitle: @design.subtitle, title: @design.title }
    assert_redirected_to design_path(assigns(:design))
  end
